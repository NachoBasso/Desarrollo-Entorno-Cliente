...
const dato1plus =document.querySelector('#dato1');
console.log(dato1plus);

const valordato1enString = dato1plus.textContent;
console.log(valordato1enString);

const dato1number = Number(valordato1enString)
console.log(dato1number);
